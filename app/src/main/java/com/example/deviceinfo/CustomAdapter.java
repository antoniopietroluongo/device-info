...
public class CustomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        if (viewType == R.layout.one_line) {
            View view = LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.one_line, viewGroup, false);
            return new ViewHolder(view);
        } else if (viewType == R.layout.two_line) {
            View view = LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.two_line, viewGroup, false);
            return new ViewHolder2(view);
        } else if (viewType == R.layout.three_line) {
            View view = LayoutInflater.from(viewGroup.getContext())
                    .inflate(R.layout.three_line, viewGroup, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        if (viewHolder.getItemViewType() == R.layout.one_line) {
            ViewHolder mViewHolder = (ViewHolder) viewHolder;
            Item item = data.get(position);
            mViewHolder.getTextView().setText(item.getStr1());
        ...
        } else if (viewHolder.getItemViewType() == R.layout.two_line) {
            ViewHolder2 mViewHolder = (ViewHolder2) viewHolder;
            Item item = data.get(position);
        ...
        } else if (viewHolder.getItemViewType() == R.layout.three_line) {
            ViewHolder3 mViewHolder = (ViewHolder3) viewHolder;
            Item item = data.get(position);
            mViewHolder.getTextView1().setText(item.getStr1());
            mViewHolder.getTextView2().setText(item.getStr2());
